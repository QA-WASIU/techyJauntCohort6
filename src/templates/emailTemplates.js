const emailTemplates = {
  ...
  welcomeTemplate: (firstName,lastName, emailToken, baseUrl = 'http://localhost:3000') => {
    return {
      subject: 'Welcome to Paylink Africa - Please Verify Your Email',
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
  ...
  loginNotificationTemplate: (firstName,lastName, loginTime, ipAddress = 'Unknown', location = 'Unknown') => {
    return {
